...
document.writeln('<tr><td height="59" align="center" valign="top" background="http://img.danawa.com/new/kdanawa/icon/img/bottom_1.gif" style="color:#666666; font-size:11px; line-height: 150%; font-family:µ∏øÚ;">¥Î«— ±√±›¡ı <a href="http://search.danawa.com/dsearch.php?nSiteCode=0&k1=<?=urlencode($sSendName)?>&tab=article&more=3" target="_top"><img src="http://img.danawa.com/new/kdanawa/icon/img/sec_search.gif" vspace="3" border="0"></a><br><a href="javascript:QnAPopOpen()"><img src="http://img.danawa.com/new/kdanawa/icon/img/btn.gif" width="53" height="14" border="0"></a></td></tr>');
<?php } else {?>
