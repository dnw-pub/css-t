...
function Scroller(x, y, width, height, border, padding, divname) {
...
function scrollerCreate() {
  ...
  if (ie||dom) {
    ...
    str = '<div id="scroller' + this.divname + '_baseLayer"'
        + ' style="position:relative;'
        + ' width:' + this.width + 'px;'
        + ' height:' + this.height + 'px;'
        + ' overflow:hidden;'
        + ' visibility:hidden;">\n'
        + '<div id="scroller' + this.divname + '_scrollLayer"'
    ...
    for (j = 0; j < this.items.length; j++) {
      str += '<div id="scroller' + this.divname + '_itemLayers' + j + '"'
          +  ' style="position:absolute;'
          +  ' width:' + this.width + 'px;'
          +  ' height:' + this.height + 'px;'
          +  ' visibility:inherit;">\n'
	...
	*/
	...
	if (ie)
	{
		eval('document.all.'+ this.divname + '.innerHTML = str');
	} else if (dom) {
		eval('document.getElementById(\"' + this.divname + '\").innerHTML = str');
	}
...
//EDIT HERE//////////////////////////////////////////////////////////////////////////////
    ...
    this.baseLayer = getLayer("scroller" + this.divname + "_baseLayer");
    this.scrollLayer = getLayer("scroller" + this.divname + "_scrollLayer");
    this.itemLayers = new Array();
    for (j = 0; j < this.items.length; j++)
      this.itemLayers[j] = getLayer("scroller" + this.divname + "_itemLayers" + j);
  }
...
function scrollerGo() {
  ...
  var i;
  //alert('scrollerList.length:' + scrollerList.length);
