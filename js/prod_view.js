...
function prodImageView(pcode, prodname, section)
{
	if(section=='game')
	{
		var url = "http://prod.danawa.com/info/popup/productImagePopup.php?pcode="+pcode+"&prodname="+prodname+"&section="+section;
		var opt = "width=650, height=740, scrollbars=no";
	}
	else
	{
		var url = "http://prod.danawa.com/info/popup/productImagePopup.php?pcode="+pcode+"&prodname="+prodname;
...
function prodImageView_SL(pcode, section)
{
	if(section=='game')
	{
		var url = "http://prod.danawa.com/info/popup/prodImageViewer.php?prod_c="+pcode+"&section="+section;
		var opt = "width=750, height=500, scrollbars=no";
	}
	else
	{
		var url = "http://prod.danawa.com/info/popup/prodImageViewer.php?prod_c="+pcode;
		var opt = "width=750, height=500, scrollbars=no";
	}
	window.open(url, "prodImage", opt);
}
...
function prodImageViewVR(pcode, section,nCurrentCate1,nCurrentCate2,nCurrentCate3,isProdListOrBlog)
{
	if(section=='game')
	{
		var url = "http://prod.danawa.com/info/popup/prodImageViewerVR.php?prod_c="+pcode+"&section="+section;
		var opt = "width=975, height=750, scrollbars=no";
	}
	else
	{
		var url = "http://prod.danawa.com/info/popup/prodImageViewerVR.php?prod_c="+pcode+"&cate1="+nCurrentCate1+"&cate2="+nCurrentCate2+"&cate3="+nCurrentCate3+"&type="+isProdListOrBlog;
		var opt = "width=975, height=750, scrollbars=no";
	}
	window.open(url, "prodImage", opt);
}
