...
function sboxShow(mode, idx)
{
	...
	if(mode=='LAY_sboxContent') {
		url = '/GenFiles/HTML/SBox/SBoxMain_lkj.'+idx+'.html?dummy='+Math.floor(Math.random()*10000);
		//sboxSave(sboxMi);
		...
		url = '/GenFiles/HTML/SBox/SBoxMain_lkj.'+mode+'.'+idx+'.html?dummy='+Math.floor(Math.random()*10000);
...
function sboxTab(idx)
{
	...
	sbTab1_img.src = 'http://img.danawa.com/new/main/shoppingbox_img/shoppingbox_tab01'+(idx==1?'_on':'')+'.gif';
	sbTab2_img.src = 'http://img.danawa.com/new/main/shoppingbox_img/shoppingbox_tab02'+(idx==2?'_on':'')+'.gif';
	sbTab3_img.src = 'http://img.danawa.com/new/main/shoppingbox_img/shoppingbox_tab03'+(idx==3?'_on':'')+'.gif';
}
