...
function goCateViewNew(cate1, cate2)
{
	...
	else if(cate2 == 870)	location.href = 'http://web0.danawa.com/elec/prod_list/prod_list_search_new_okioki.php?defSite=NOTEBOOK&topposition=NB&cate1='+cate1+'&cate2='+cate2;
	else if (cate1 == 197 && cate2==532) //mp3
		location.href = 'http://web0.danawa.com/elec/prod_list/prod_list_search_new_okioki.php?defSite=PC&pc=pc&cate1='+cate1+'&cate2='+cate2;
	else
		location.href = 'http://web0.danawa.com/elec/prod_list/prod_list_search_new_okioki.php?defSite=PC&pc=pc&cate1='+cate1+'&cate2='+cate2;
}
...
function pBlog(param)
{
	...
	var url = "http://blog.danawa.com/prod/"+param;
