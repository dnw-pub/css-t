...
{
	// area 삽입
	html_tag01='<div style="left:0px; padding:0px; width:210; border:ridge 0px #FF0000; position:absolute; top: '+(scrollerheight01*n)+'px" id="scroll_area1'+n+'">\n';
	html_tag01+='<a href="javascript:GoAdvLink()" class="hot01">\n';
	html_tag01+=scroll_content1[idx]+'\n';
	html_tag01+='</a>\n';
	html_tag01+='</div>\n';
	//document.write(html_tag);
	document.getElementById("scroll_image").innerHTML += html_tag01;
}
