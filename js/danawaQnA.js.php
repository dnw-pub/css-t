...
document.writeln('<a href="http://help.danawa.com/" target="_blank"><img src="http://img.danawa.com/new/main_new/img/btn_help.gif"></a>');
...
<?php } ?>
<?php if($sSendName) {?>
document.writeln('<p class="dargCate" style="margin:0;"><strong><?=$sSendName?></strong>에 대한 궁금증</p>');
<?php } else { /*?>
document.writeln('<p class="dargCate">무엇이든<br/>물어보세요!!</p>');
<?php */} ?>
document.writeln('<p class="dargBtn" style="margin:0;">');
