...
{
	if(cate2 == 869)		location.href = '/notebook/';
	else if(cate2 == 870)	location.href = '/price_new.html?topposition=NB&cate1='+cate1+'&cate2='+cate2;
	else if (cate1 == 197 && cate2==532)
	{
		location.href = '/price_new.html?pc=pc&cate1='+cate1+'&cate2='+cate2;
	}
	else					location.href = '/price_new.html?pc=pc&cate1='+cate1+'&cate2='+cate2;
}
...
function goCateViewDICA(cate1,cate2, Ca_ram)
{
	if(Ca_ram == '')
	{
		document.location.href='http://pc.danawa.com/price_new.html?dica=dica&cate1='+cate1+'&cate2='+cate2;
	}
	else
	{
		document.location.href='http://pc.danawa.com/price_new.html?dica=dica&cate1='+cate1+'&cate2='+cate2+'&Ca_ram='+Ca_ram;
	}
...
{
	location.href='/price_new.html?topposition=NB&cate1='+cate1+'&cate2='+cate2;
}


function goNotebookView(opt)
{
	var link = '/price_new.html?topposition=NB&cate1=860&cate2=869';
...
{
	var link;
	link			= '/price_new.html?topposition=NB&cate1='+cate1+'&cate2='+cate2+'&SearchCombo='+val;
	location.href	= link;
}
