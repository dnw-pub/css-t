...
function prodImageViewVR(pcode, section,nCurrentCate1,nCurrentCate2,nCurrentCate3,isProdListOrBlog)
{
	if(section=='game')
	{
		var url = "http://www.danawa.com/product/prodImgViewerVR_mmm.html?prod_c="+pcode+"&section="+section;
		var opt = "width=970, height=870, scrollbars=no";
	}
	else
	{
		var url = "http://www.danawa.com/product/prodImgViewerVR_mmm.html?prod_c="+pcode+"&cate1="+nCurrentCate1+"&cate2="+nCurrentCate2+"&cate3="+nCurrentCate3+"&type="+isProdListOrBlog;
		var opt = "width=970, height=870, scrollbars=no";
	}
	window.open(url, "prodImage", opt);
}
