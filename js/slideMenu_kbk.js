...
SlideMenu.Slide.prototype = 
{
	RefreshStaticMenu : function ()	{
		...
		//stmnEndPoint	= document.documentElement.scrollTop + this.nYY;
		//stmnEndPoint	= document.body.scrollTop + this.nYY;
		//stmnEndPoint	= window.pageYOffset + this.nYY;
	...
	Start : function (obj) {
		...
		//this.obj.style.top	= document.documentElement.scrollTop + this.nZ + 'px';
		//this.obj.style.top	= document.body.scrollTop + this.nZ  + 'px';
		//this.obj.style.top	= window.pageYOffset + this.nZ  + 'px';
